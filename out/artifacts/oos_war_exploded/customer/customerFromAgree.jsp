...
<head>
    ...
    <!-- 加载CSS -->
    <link rel="stylesheet" type="text/css" href="css/style.css~1523913323418.css" />
    <link rel="stylesheet" type="text/css" href="css/jquery-ui.css~1523913323418.css" />
    <!-- 加载JS -->
    <script type="text/javascript" src="js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="js/min/vendor/jquery-1.8.3/jquery.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/vendor/customerFromAgreejs/jquery.cookie.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/vendor/customerFromAgreejs/jquery.lazyload.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/vendor/customerFromAgreejs/jquery.ui.yumdialog.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/property_cn.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/common/base.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/sdc_kfc.js~1523913323418"></script>
    <!-- kfc_ios add js wanglei4 20150528  start-->
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/pageToUrl.js~1523913323418"></script>
    ...
    <link rel="stylesheet" type="text/css" href="css/jquery.autocomplete.css~1523913323418.css" />
</head>
<body>
    <div class="con">
        <!-- 标题 -->
        <div id="top">
            ...
            <a href="http://www.4008823823.com.cn/kfcios/Html/index.html"><div class="logo"></div></a>
            <div class="top_menu">
            ...
            <div class="login_content">
                <div class="">
                    <form id="mainForm" action="">
                        <input type="hidden" name="orderFlag" id="orderFlag" value="" />
                        <input type="hidden" name="token_for_request" value="4f222261-f75a-475e-aa22-78e8dc593930" />
                        <input type="hidden" id="tag" value="customer" />
                        <input type="hidden" id="cid" name="cid" value="63dd012e-ad1b-467f-840b-be781de56bb1" />
                        <input type="hidden" id="storeId" name="storeId" value="" />
                        <input type="hidden" id="userFlag" name="userFlag" value="0" />
                        <input type="hidden" id="phoneFlag" name="phoneFlag" value="" />
                        <input type="hidden" id="curDate" name="curDate" value="2018年04月17日" />
                        <input type="hidden" id="delivery" name="delivery" value="" />
                        <input type="hidden" id="mobiLogin" name="mobiLogin" value="" />
                        <input type="hidden" id="mobi" name="mobi" value="" />
                        <input type="hidden" id="mobiOrMail" name="mobiOrMail" value="18564793215" />
                        <input type="hidden" id="phoneUserFlag" value="" />
                        <input id="displayUserAgreement" name="displayUserAgreement" type="hidden" value="0" />
                        <div class="address_manage">
                            ...
                            <div class=" info_table">
                                <div id="addAddress">
                                    <div style="width:11%;float:left">
                                        ...
                                        <span class="span_2" address2=address2 style="display:none">路名/小区名：</span>
                                        <span class="span_2" address3=address3 style="display:none">请继续填全：</span>
                                        <span class="span_2" address4=address4 style="display:none">请继续填全：</span>
                                        <span class="span_2" address5=address5>联系人：</span>
                                        <span class="span_2" address6=address6>联系电话：</span>
                                    </div>
                                    <div style="width:760px">
                                        <div id="import_addr_tip"></div>
                                        <a href="javascript:;" style="display: none;" onclick="$(this).hide().next('div').show();" id="addressAdd">新增</a>
                                        <!--添加送餐地址开始-->
                                                            ...
                                                            <div class="add_address">
                                                                <p>
                                                                    <span class="new_tel_input">
                                                                        <input id="cityName" type="text" class="input_5" autocomplete="off" />
                                                                        <span class="add_icon" id="query_city"></span>
                                                                        <span class="location"></span>
                                                                    </span>
                                                                </p>
                                                                <p id="add_add2" address2=address2 style="display:none">
                                                                    <input id="address2" style="width:188px " type="text" class="input_4" autocomplete="off" />
                                                                ...
                                                                <p id="add_add3" address3=address3 style="display:none">
                                                                    <input id="address3" type="text" maxlength="10" class="input_3" autocomplete="off" />
                                                                </p>
                                                                <p id="add_add4" address4=address4 style="display:none">
                                                                    <input id="address4" type="text" maxlength="10" class="input_3" autocomplete="off" />
                                                                </p>
                                                                <p id="add_add5" address5=address5>
                                                                    <input id="linkman" type="text" class="input_4" style="width:188px" autocomplete="off" />&nbsp;&nbsp;
                                                                    <input id="gender0" name="gender" type="radio" value="0" checked=checked checked=checked checked=checked checked=checked />&nbsp;先生
                                                                    &nbsp;&nbsp;
                                                                    <input id="gender1" name="gender" type="radio" value="1" />&nbsp;女士
                                                                </p>
                                                                <p id="add_add6" address6=address6>
                                                                    <input id="linkphone" name="linkphone" type="text" style="width:188px" maxlength="11" class="input_4" autocomplete="off" />
                                                                ...
                                                                <div class="city_list" id="city_list" style="display: none;">
                                                                    ...
                                                                    <div class="city_box">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BHXQ">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGQIAOQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIANGYIQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QINBEIQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIUYANG">
                                                                            <a realname="浏阳" cityname="浏阳(浏阳)" citynameen="LIUYANG" citycode="00219" name="choose_city_btn" href="javascript:;" id="districtName">浏阳</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HONGGUTAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="RUICHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QIANAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XIANGFAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUSHUIQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIZHOUQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANYUANQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHANHAIGUANQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LONGYANGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LUOZHUANGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LONGHUAXINQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NANMINGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HAICHENGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGJIA">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUNMENGXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HANCHUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIAOBUZHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TAIXINGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LONGQUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DUJIANGYAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGGUANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUARONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUIYANGXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WENFENGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINYI">
                                                                            <a realname="徐州" cityname="新沂市(徐州)" citynameen="XINYI" citycode="00169" name="choose_city_btn" href="javascript:;" id="districtName">新沂市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LAOYUHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NINGGUO">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QIHE">
                                                                            <a realname="德州" cityname="齐河县(德州)" citynameen="QIHE" citycode="03024" name="choose_city_btn" href="javascript:;" id="districtName">齐河县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PENGLAISHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINGCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="MENGCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LINQUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TAIHE">
                                                                            <a realname="阜阳" cityname="太和县(阜阳)" citynameen="TAIHE" citycode="00733" name="choose_city_btn" href="javascript:;" id="districtName">太和县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TONGCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SUSONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHUCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DINGYUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LONGKOUSHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FUNAN">
                                                                            <a realname="阜阳" cityname="阜南县(阜阳)" citynameen="FUNAN" citycode="00733" name="choose_city_btn" href="javascript:;" id="districtName">阜南县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGTU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NANLING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DANGTU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HAINING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGLE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="KAIYUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HONGZE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANTU">
                                                                            <a realname="延边" cityname="安图县(延边)" citynameen="ANTU" citycode="01465" name="choose_city_btn" href="javascript:;" id="districtName">安图县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="KAIHUA">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YIZHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINHUA">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHAODONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGKOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGXING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANPING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PUNING">
                                                                            <a realname="揭阳" cityname="普宁(揭阳)" citynameen="PUNING" citycode="00087" name="choose_city_btn" href="javascript:;" id="districtName">普宁</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIANSHUI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LINXIANGSHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PEIXIAN">
                                                                            <a realname="徐州" cityname="沛县(徐州)" citynameen="PEIXIAN" citycode="00169" name="choose_city_btn" href="javascript:;" id="districtName">沛县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SUINING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XUYI">
                                                                            <a realname="淮安" cityname="盱眙县(淮安)" citynameen="XUYI" citycode="00336" name="choose_city_btn" href="javascript:;" id="districtName">盱眙县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIANYUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TIANCHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUANGSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUANGCHUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GAOYOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUAXIAN">
                                                                            <a realname="安阳" cityname="滑县(安阳)" citynameen="HUAXIAN" citycode="01608" name="choose_city_btn" href="javascript:;" id="districtName">滑县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="MILE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WULIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGCHUN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUNCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YINGSHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUAIYUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="MINGGUANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANFU">
                                                                            <a realname="吉安" cityname="安福县(吉安)" citynameen="ANFU" citycode="00528" name="choose_city_btn" href="javascript:;" id="districtName">安福县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DANGYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHONGYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GEYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PINGDU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DUNHUA">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TONGXIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="MANZHOULI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PIZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WENDENGSHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUADIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GONGANXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DINGAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WUYIXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QICHUN">
                                                                            <a realname="黄冈" cityname="蕲春(黄冈)" citynameen="QICHUN" citycode="00672" name="choose_city_btn" href="javascript:;" id="districtName">蕲春</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DACHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YIXIAN">
                                                                            <a realname="保定" cityname="易县(保定)" citynameen="YIXIAN" citycode="00619" name="choose_city_btn" href="javascript:;" id="districtName">易县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WANGCHENGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HAILAER">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DAOXIAN">
                                                                            <a realname="永州" cityname="道县(永州)" citynameen="DAOXIAN" citycode="01513" name="choose_city_btn" href="javascript:;" id="districtName">道县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHONGXIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANHUA">
                                                                            <a realname="益阳" cityname="安化县(益阳)" citynameen="ANHUA" citycode="04536" name="choose_city_btn" href="javascript:;" id="districtName">安化县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHOUGUANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WUXUESHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YIFENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DAYE">
                                                                            <a realname="黄石" cityname="大冶市(黄石)" citynameen="DAYE" citycode="00439" name="choose_city_btn" href="javascript:;" id="districtName">大冶市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TONGSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANLU">
                                                                            <a realname="孝感" cityname="安陆市(孝感)" citynameen="ANLU" citycode="00576" name="choose_city_btn" href="javascript:;" id="districtName">安陆市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XUANWEI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHAYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DUCHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NANANSHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DEHUAXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGPING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YICHUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GAIZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LAIFENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FENGJIE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JINGGANGZHEN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="MINQING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHIJIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUGAN">
                                                                            <a realname="上饶" cityname="余干县(上饶)" citynameen="YUGAN" citycode="00408" name="choose_city_btn" href="javascript:;" id="districtName">余干县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NINGYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LINYI">
                                                                            <a realname="德州" cityname="临邑县(德州)" citynameen="LINYI" citycode="03024" name="choose_city_btn" href="javascript:;" id="districtName">临邑县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LUANNAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JINXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BOXING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TANCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HEISHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BOLUO">
                                                                            <a realname="惠州" cityname="博罗县(惠州)" citynameen="BOLUO" citycode="00193" name="choose_city_btn" href="javascript:;" id="districtName">博罗县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LAOHEKOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NANFENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LAIXI">
                                                                            <a realname="青岛" cityname="莱西市(青岛)" citynameen="LAIXI" citycode="00289" name="choose_city_btn" href="javascript:;" id="districtName">莱西市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QINYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHUANGHE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FUQING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHAHE">
                                                                            <a realname="邢台" cityname="沙河市(邢台)" citynameen="SHAHE" citycode="00216" name="choose_city_btn" href="javascript:;" id="districtName">沙河市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YINGSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGLI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YINGDE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BEIDAIHE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHUYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FUDING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BAOYING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FUAN">
                                                                            <a realname="宁德" cityname="福安市(宁德)" citynameen="FUAN" citycode="00027" name="choose_city_btn" href="javascript:;" id="districtName">福安市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FENGSHUN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGJI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HOUMA">
                                                                            <a realname="临汾" cityname="侯马市(临汾)" citynameen="HOUMA" citycode="00745" name="choose_city_btn" href="javascript:;" id="districtName">侯马市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LINGBAO">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HAIMEN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GAOPING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DINGXING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GAOBEIDIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JINGXI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JINTAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NINGJIN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHUANGLIAO">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PUCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HANCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHENGCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="RUDONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DENGTA">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HONGAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHALANTUN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUANPING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LEPING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHIMEN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YICHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LINLIXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WENAN">
                                                                            <a realname="廊坊" cityname="文安县(廊坊)" citynameen="WENAN" citycode="00859" name="choose_city_btn" href="javascript:;" id="districtName">文安县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUYAOSHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINZHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YIPENGJIEDAO">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XIANXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="NANLANGZHEN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIANYUNQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QUANJIAOXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DAWUXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHOUXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XIAOCHANGXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HEXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LONGJINAGXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHISHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHENZHOUSHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIANLI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHONGZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHAOYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LAOCHENGQU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YANGXIN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="FUNING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BINHAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XIANGSHUI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHONGMOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DAISHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WENSHANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIANZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUSHI">
                                                                            <a realname="信阳" cityname="固始县(信阳)" citynameen="GUSHI" citycode="01704" name="choose_city_btn" href="javascript:;" id="districtName">固始县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GAOYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHIDAO">
                                                                            <a realname="荣成" cityname="石岛(荣成)" citynameen="SHIDAO" citycode="03816" name="choose_city_btn" href="javascript:;" id="districtName">石岛</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="RONGCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANYUE">
                                                                            <a realname="资阳" cityname="安岳县(资阳)" citynameen="ANYUE" citycode="02760" name="choose_city_btn" href="javascript:;" id="districtName">安岳县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIANHU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JINZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ALASHANZUOQI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGNING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HENGDONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BOLE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHANXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="AKESU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIAXIANGXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGXIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DUNHUANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XIANGGELILA">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIANYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QIDONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LENGSHUIJIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LUFENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="RENHUAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LILING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUAIREN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="RUSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ANDA">
                                                                            <a realname="绥化" cityname="安达市(绥化)" citynameen="ANDA" citycode="01201" name="choose_city_btn" href="javascript:;" id="districtName">安达市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TENGZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZOUPING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUIDONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QUFU">
                                                                            <a realname="济宁" cityname="曲阜市(济宁)" citynameen="QUFU" citycode="01333" name="choose_city_btn" href="javascript:;" id="districtName">曲阜市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGKANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="MINHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DONGHAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUANNAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SIYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="QIONGLAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINTAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LUJIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SIHONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHUCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GAOMI">
                                                                            <a realname="潍坊" cityname="高密市(潍坊)" citynameen="GAOMI" citycode="00505" name="choose_city_btn" href="javascript:;" id="districtName">高密市</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LAIYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YONGCHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PINGSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGYUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="PINGYU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHANGPU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUIXIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LUXI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINLE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HONGDONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WEISHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JINXIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TENGCHONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="ZHONGJIANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LONGHAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="CHANGYI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YUZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIAGEDAQI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HAIYANG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="BEIPIAO">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LINGHAI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YIZHENG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="EMEISHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SONGZI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WUDI">
                                                                            <a realname="滨州" cityname="无棣县(滨州)" citynameen="WUDI" citycode="02640" name="choose_city_btn" href="javascript:;" id="districtName">无棣县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="HUIMIN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIJIN">
                                                                            <a realname="东营" cityname="利津县(东营)" citynameen="LIJIN" citycode="00331" name="choose_city_btn" href="javascript:;" id="districtName">利津县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIULIN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SUIDE">
                                                                            <a realname="榆林" cityname="绥德县(榆林)" citynameen="SUIDE" citycode="00360" name="choose_city_btn" href="javascript:;" id="districtName">绥德县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINGNING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XILINHAOTE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="RUZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WUWEI">
                                                                            <a realname="芜湖" cityname="无为县(芜湖)" citynameen="WUWEI" citycode="00253" name="choose_city_btn" href="javascript:;" id="districtName">无为县</a>
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YINING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DANJIANGKOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="LIANGSHAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="WANNIAN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XISHUI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="SHANGZHI">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="GUANGDE">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="TAISHUN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="XINMIN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="DENGZHOU">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JIANGYIN">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YIXING">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="YANGZHONG">
                                                                        ...
                                                                        </span>						<span class="city_mode" style="display: none;" firstletter="JURONG">
                            ...
                            <div class="the_other_day_tip"></div>
                            <div>
                                <div>
                                    <div>
                                    </div>
        ...
        <!--footer start-->
        <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/common/chatService.js~1523913323418"></script>
        <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/common/DSPCommon.js~1523913323418"></script>
        <!-- 加载定制CSS -->
        <link rel="stylesheet" type="text/css" href="http://res.4008823823.com.cn/kfcios/Html/res/css/default.css?1523913323418" />
        <!-- 弹出层 -->
    ...
    <!-- 地图弹出层 -->
    <div id="emapPopup" style="display:none;overflow: hidden;border:0px solid #ccc;background-color: #fff;">
        <div id="map_cont" style="overflow: hidden;width:750px;height:400px;border:0px dotted #ccc;">
            <div id="closeDiv" style="height: 26px;width: 26px;cursor:pointer; background: url(http://res.4008823823.com.cn/kfcios/Html/res/images/close.png) no-repeat;position: absolute;top: 0px;right: 0px;z-index:9999;"></div>
            <div style="float:left;width:100%;height:100%">
                <div style="float:left;width:202px">
                    <div style="top:5px;left:5px;">路名/小区名：</div>
                    <div style="top:5px;left:5px;display:inline;">
                        <input type="text" align="middle" style="float: left; width: 134px;" id="searchaddr" />
                        <span style="float:left;margin:0 0 8px 2px;width:62px;height:21px;background-color: #e4393c;text-align:center">
                            <a id="searchbutton" style="color: #fff;line-height: 21px;">查询</a>
                        </span>
                    </div>
                    <div id="addressresult" style="top:55px;left:5px;width:200px;height:270px;word-break:break-all;word-wrap:break-world;" class="emapaddr_results">下拉框</div>
                </div>
                <div style="float:left">
                    <div style="position:absolute;top:25px;margin-left:5px;z-index:9999;">
                        <img id="zoomin" style="position:relative;left:5px;top:5px;z-index:9999;" src="images/zoomin.png" />
                        <img id="zoomout" style="position:relative;left:5px;top:5px;z-index:9999;" src="images/zoomout.png" />
                    </div>
                    <div id="addressMap" style="position:absolute;top:25px;margin-left:5px;width:480px; height:290px;border:2px solid #fff;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- 地图弹出层 -->
    <!-- 加载JS -->
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/autonavi_config_common.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/config.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/vendor/customerFromAgreejs/jquery.autocomplete.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/vendor/customerFromAgreejs/jquery.custom.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/customer_new.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/address.js~1523913323418"></script>
    <script type="text/javascript" src="js/min/yum/customerFromAgreejs/kfc/cityChoose.js~1523913323418"></script>
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('') {
                if ('' == '001') {
                    //餐厅仅在（10:00-22:00）提供订餐服务！
                    var timeArr = ['', ''];
                    base.yumAlert(codeMessage.error001.format(timeArr));
                } else {
                    error.yumAlertError('');
                }
            }
            //如果有一个地址，则被选中
            if (window.self.addressList.length == 1 && (!$('[name=selAddressId]:checked')[0])) {
                $("input[name='selAddressId']").first().click();
            }
            if ('0' == '0') {
                window._tag && window._tag.dcsMultiTrack('wt.event', '用户类型', 'wt.msg', '新用户', 'wt.userid', '');
                if ('false' == 'true') {
                    pageInfo('firstview');
                    pageInfo('addressview');
                    pageInfo('timeview');
                    pageInfo('confirmview');
                }
            }
        });
    </script>
