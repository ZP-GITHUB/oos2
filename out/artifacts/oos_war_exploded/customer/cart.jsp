...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style.css~1524344121029.css" />
    <link rel="stylesheet" type="text/css" href="css/jquery-ui.css~1524344121029.css" />

    <!-- 加载JS -->
    <script type="text/javascript" src="js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="js/min/vendor/jquery-1.8.3/jquery.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/vendor/cart/jquery.cookie.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/vendor/cart/jquery.lazyload.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/vendor/cart/jquery.ui.yumdialog.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/yum/cart/property_cn.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/yum/cart/kfc/common/base.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/yum/cart/kfc/sdc_kfc.js~1524344121029"></script>

    <!-- kfc_ios add js wanglei4 20150528  start-->
    <script type="text/javascript" src="js/min/yum/cart/pageToUrl.js~1524344121029"></script>

    <!--  kfc_ios add js wanglei4 20150528  end -->
    <script src="js/min/yum/cart/kfc/cart.js~1524344121029" type="text/javascript" language="javascript"></script>
    <script type="text/javascript" src="js/min/vendor/cart/jquery.md5.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/vendor/cart/fingerprint.js~1524344121029"></script>
...
<body>
    ...
    <!--footer start-->
    <script type="text/javascript" src="js/min/yum/cart/kfc/common/chatService.js~1524344121029"></script>
    <script type="text/javascript" src="js/min/yum/cart/kfc/common/DSPCommon.js~1524344121029"></script>
    <!-- 加载定制CSS -->
...
<script type="text/javascript" src="js/min/vendor/cart/rc.fp.js~1524344121029"></script>