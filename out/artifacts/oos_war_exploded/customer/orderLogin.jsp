...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="css/style.css~1523913921996.css"/>
    <link rel="stylesheet" type="text/css"
          href="css/jquery-ui.css~1523913921996.css"/>
    <!-- 加载JS -->
    <script type="text/javascript" src="js/jquery-3.3.1.js"></script>
    <script type="text/javascript" src="js/common.js"></script>
    <script type="text/javascript" src="js/orderLogin.js"></script>
</head>
<body>
                ...
                <li id="showVerifyCode" style="display: none">
                    <div class="validate_user_line">
                        <div class="validate_user_value">
                            <input id="validate_user_smscode"
                                   class="validate_user_input validate_user_smscode"/>
                            <div class="validate_btn" id="sendPointSmscode">发送验证码</div>
                        </div>
                    </div>
                </li>
